...
class _SimilarCaseDetailedView extends State<SimilarCaseDetailedView> {
  ...
  Future<void> getCaseDetails() async {
    ...
    CustomResponse response = await ApiCall.makeGetRequestToken(
        'incident/get?id=${widget.similarCaseId}&lat=${currentLocation.latitude}&lon=${currentLocation.longitude}');
  ...
  Future<void> addToWatchList() async {
    Map data = {"id": caseDetails["_id"]};
    var response = await ApiCall.makePostRequestToken("incident/watchlist/add",
        paramsData: data);
  ...
  void _onShareTap(var linkMessage) {
    int treeCount = caseDetails["mightbecut"] +
        caseDetails["beencut"] +
            ...
            child: Scaffold(
              appBar: AppBar(
                              ...
                              Navigator.push(
                                  ...
                                  MaterialPageRoute(
                                      builder: (context) => ReportCase(
                                          widget.similarCaseId, caseDetails)));
                          },
                        )
                      ],
                bottom: TabBar(
                ...
                title: Text(
                  dataLoading
                      ? ""
                      : '${caseDetails["caseidentifier"] == null ? caseDetails["caseid"] : caseDetails["caseidentifier"]}',
                  style: TextStyle(color: Colors.black),
                ),
              ),
              body: !dataLoading
...
class _CaseSummary extends State<CaseSummary> {
  ...
  Future<Uint8List> getBytesFromAsset(String path, int width) async {
    ...
    if (data.buffer == null)
      throw Exception('Failed to load asset: buffer is null');
    ...
    if (byteData?.buffer == null)
      throw Exception('Failed to encode image: buffer is null');
    ...
    markers.add(Marker(
        ...
        onTap: () {
          CommonFunction.openMap(
              caseChart["location"][1], caseChart["location"][0]);
        }));
    imageList.clear();
                      ...
                      children: <Widget>[
                        ...
                        Container(
                          ...
                          child: Swiper(
                            ...
                            pagination: caseChart["photos"].length > 1
                                ? SwiperPagination()
                                : SwiperPagination(
                          ...
                          children: [
                            Expanded(
                              child: Column(
                                ...
                                children: [
                                  Text(
                                    isCaseHasUpdates && sliderValue == 0
                                        ? "Posted by:"
                                        : "Updated by:",
                                    style: TextStyle(
                                      fontSize: 12,
                                  ...
                                  Row(
                                    ...
                                    children: <Widget>[
                                      ...
                                      Container(
                                        ...
                                        child: Text(
                                          "${caseChart["beencut"] + caseChart["mightbecut"] + caseChart["havebeencut"]}",
                                      ...
                                      SizedBox(
                                        width: caseChart["mightbecut"] == 0
                                            ? 0
                                            : 8,
                                      ),
                                      caseChart["mightbecut"] == 0
                                          ? SizedBox.shrink()
                                          : Container(
                                              decoration: BoxDecoration(
                                                  color: Colors.orange,
                                      ...
                                      SizedBox(
                                        width: caseChart["havebeencut"] == 0
                                            ? 0
                                            : 8,
                                      ),
                                      caseChart["havebeencut"] == 0
                                          ? SizedBox.shrink()
                                          : Container(
                                              decoration: BoxDecoration(
                                                  color: Colors.grey,
                        ...
                        Container(
                          ...
                          child: GoogleMap(
                            ...
                            initialCameraPosition: CameraPosition(
                              target: LatLng(caseChart["location"][1],
                                  caseChart["location"][0]),
                              zoom: 15.77,
                            ),
                            markers: markers,
                                ...
                                child: Column(
                                  children: <Widget>[
                                    ...
                                    Container(
                                      ...
                                      child: caseChart["mightbecutreason"]
                                              .isNotEmpty
                                          ? Column(
                                              children:
                                                  mightBeCutReason(context),
                                            )
                                          : SizedBox.shrink(),
                                    ),
                                  ],
                                ...
                                child: Row(
                                  ...
                                  children: <Widget>[
                                    ...
                                    Expanded(
                                      ...
                                      child: Center(
                                          child: Text(
                                        caseChart["havebeencut"].toString() ??
                                            " ",
                                        style: TextStyle(
                                            fontWeight: FontWeight.w600),
                                      )),
                        ...
                        MaterialButton(
                          elevation: 1.0,
                          splashColor: state.isInWatchList
                          ...
                          height: 50.0,
                          textColor:
                              state.isInWatchList ? Colors.white : Colors.black,
                          onPressed: () => state.isInWatchList
                              ? removeFromWatchList()
                              : addToWatchList(),
                          child: Center(
                              child: Text(state.isInWatchList
                        ...
                        MaterialButton(
                          ...
                          onPressed: () async {
                            var link = await CommonFunction.createDynamicLink(
                                ...
                                title:
                                    "Case ID: ${caseChart["caseidentifier"] == null ? caseChart["caseid"].toString() : caseChart["caseidentifier"].toString()}",
              ...
              CircleAvatar(
                ...
                backgroundImage:
                    caseChart["comments"][i]["user"]["photo"] != null
                        ? CachedNetworkImageProvider(ApiCall.imageUrl +
                                caseChart["comments"][i]["user"]["photo"] ??
                            " ")
                        : null,
              ),
              SizedBox(
                ...
                children: [
                  Text(
                    caseChart["comments"][i]["user"]["name"] != null
                        ? caseChart["comments"][i]["user"]["name"]
                        : "Anonymous",
                    style: TextStyle(
                        fontWeight: FontWeight.w800,
                        fontSize: 12,
          ...
          Padding(
            ...
            child: Text(
              CommonFunction.timeCalculation(
                  caseChart["comments"][i]["createdAt"]),
              style: TextStyle(
                  color: Colors.grey,
                  fontSize: 11.5,
                  fontWeight: FontWeight.w600),
...
//------- Case Update Dialog------------
                      ...
                      child: Center(
                        child: Column(
                            ...
                            children: [
                              ...
                              Column(
                                children: updateRenderList(context),
                              ),
                            ]),
                      ),
                    )
            ...
            children: <Widget>[
              ...
              Row(
                ...
                children: <Widget>[
                  ...
                  Text(
                    "${widget.caseDetails["updates"][i]["beencut"] + widget.caseDetails["updates"][i]["mightbecut"] + widget.caseDetails["updates"][i]["havebeencut"]}",
                  ...
                  FittedBox(
                    ...
                    child: Container(
                      ...
                      child: FittedBox(
                          ...
                          child: Text(
                            widget.caseDetails["updates"][i]["beencut"]
                                    .toString() ??
                                "",
                  ...
                  Expanded(
                    ...
                    child: Text(
                      widget.caseDetails["updates"][i]["isanonymous"]
                          ? "Anonymous"
                          : widget.caseDetails["updates"][i]["addedby"]
                                      ["name"] ==
                                  null
                              ? " "
                              : widget.caseDetails["updates"][i]["addedby"]
              ...
              widget.caseDetails["updates"][i]["description"] != null
                  ? Text(
  ...
  Future<void> addToWatchList() async {
    Map data = {"id": widget.caseDetails["_id"]};
    CustomResponse response = await ApiCall.makePostRequestToken(
  ...
  void _onShareTap(var linkMessage) {
    int treeCount = widget.caseDetails["mightbecut"] +
        widget.caseDetails["beencut"] +
        widget.caseDetails["havebeencut"];
    String text = "Checkout this case about $treeCount " +
        "${treeCount > 1 ? "trees" : "tree"}" +
        " at " +
        widget.caseDetails["locationname"] +
        " using Save Tress app. (Case ID: ${widget.caseDetails["caseidentifier"] == null ? widget.caseDetails["caseid"].toString() : widget.caseDetails["caseidentifier"]})";
  ...
  Future<void> markUpdate() async {
    ...
    if (json.decode(response.body)["status"]) {
      ...
      Future.delayed(Duration(milliseconds: 2000), () {
        ...
        CommonWidgets.upDationMarkDialog(
            context, widget.caseDetails, 'updated');
      });
    } else
      Fluttertoast.showToast(msg: json.decode(response.body)["msg"]);
  }
