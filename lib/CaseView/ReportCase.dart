...
class _ReportCase extends State<ReportCase>{
  ...
  void initState(){
    ...
    for(int i=0; i<widget.incidentDetails["photos"].length; i++)
      casePhotos.add(PhotoDetails(widget.incidentDetails["photos"][i]["_id"], widget.incidentDetails["photos"][i]["photo"], false));

    if(widget.incidentDetails["updates"].isNotEmpty)
      for(int j=0; j<widget.incidentDetails["updates"].length; j++)
        for(int k=0; k<widget.incidentDetails["updates"][j]["photos"].length; k++)
          casePhotos.add(PhotoDetails(widget.incidentDetails["updates"][j]["photos"][k]["_id"], widget.incidentDetails["updates"][j]["photos"][k]["photo"], false));
  }

  var userName = "";  String selectedUserType;
...
TextEditingController _descriptionController = TextEditingController();
  ...
  bool isSpamContent = false, isViolence = false, isInappropriateLanguage = false, isNoTreePicture = false, isOthers = false;
   ...
   return Scaffold(
       ...
       child: AnimationLimiter(
         child: Column(
           ...
           children: AnimationConfiguration.toStaggeredList(
             ...
             children:  [
               Text("Reason:", style: TextStyle(fontWeight: FontWeight.w700),),
               ...
               GestureDetector(
                 ...
                 child: Row(
                   children: <Widget>[
                     ...
                     Expanded(
                       child: Text("Spam content ( ads, memes etc)",
                         style: TextStyle(fontWeight: isSpamContent?  FontWeight.w800 : FontWeight.normal),
               ...
               GestureDetector(
                 ...
                 child: Row(
                   children: <Widget>[
                     ...
                     Expanded(
                       child: Text("Graphic images, violence etc",
                         style: TextStyle(fontWeight: isViolence ? FontWeight.w800: FontWeight.normal),
                   ...
                   children: <Widget>[
                     ...
                     Expanded(
                       child: Text("Inappropriate language",
                         style: TextStyle(fontWeight:  isInappropriateLanguage?  FontWeight.w800: FontWeight.normal),
                         overflow: TextOverflow.ellipsis, maxLines: 3,
                       ),
                     ),
                   ],
               ...
               GestureDetector(
                 ...
                 child: Row(
                   children: <Widget>[
                     ...
                     Expanded(
                       child: Text("No picture of trees",
                         style: TextStyle(fontWeight: isNoTreePicture ? FontWeight.w800 : FontWeight.normal),
                         overflow:  TextOverflow.ellipsis, maxLines: 3,
                       ),
                     ),
                   ],
               ...
               GestureDetector(
                 ...
                 child: Row(
                   children: <Widget>[
                     ...
                     Expanded(
                       child: Text("Other",
                         style: TextStyle(fontWeight: isOthers? FontWeight.w800: FontWeight.normal),
                         overflow:  TextOverflow.ellipsis, maxLines: 3,
                       ),
                     ),
                   ],
               ...
               TextFormField(
                   ...
                   decoration: InputDecoration(
                     ...
                     border: OutlineInputBorder(
                         ...
                         borderSide: BorderSide(width: MaterialTools.borderWidth, style: BorderStyle.none, color: MaterialTools.borderColor)
                     ),
                   )
               ),

               SizedBox(height: 10.0,),
               Text("Select the inappropriate pictures", style: TextStyle(color: Colors.black54),),
               SizedBox(height: 8.0,),
               ...
               SizedBox(height: 10.0,),
               Text("Your report will be sent for review, if your reasons are valid we will take action accordingly."),
               SizedBox(height: 20.0,),

               userName == "" || userName == null ? SizedBox.shrink():
               Row(
                 mainAxisAlignment: MainAxisAlignment.center,
                 children: [
                   Text("I want to report this case as:")
                 ],
               ),

               userName == "" || userName == null ?
               SizedBox.shrink() : Center(
                 child: Wrap(
                   ...
                   children: <Widget>[
                     ...
                     userName == "" || userName == null ? SizedBox.shrink() :Text(
                     ...
                     Text("Anonymous", maxLines: 3,overflow: TextOverflow.ellipsis),
                   ],
                 ),
               ),
     ...
     floatingActionButton:  Opacity(
       ...
       child: MaterialButton(
         ...
         onPressed: (){
           if( !isSpamContent && !isViolence && !isInappropriateLanguage && !isNoTreePicture && !isOthers){
             CommonWidgets.alertBox(context, "Please Choose the reason", leaveThatPage: false);
           }
           else
             reportFalseAlarm();
         },
         ...
         child: Wrap(
           ...
           children: [
             Row(
               mainAxisAlignment: MainAxisAlignment.center,
               children: [
                 Text("REPORT CASE", style: TextStyle(fontWeight: FontWeight.bold),),
        ...
        itemBuilder: (context, index) {
          return Stack(
            children: <Widget>[
              GestureDetector(
                onTap :() {
                  setState(() {
                    ...
                    casePhotos[index].selected ? selectedImageList.add(casePhotos[index].imageId) : selectedImageList.remove(casePhotos[index].imageId);
                  });
                },
                child: Container(
                    ...
                    child: ClipRRect(
                      borderRadius: BorderRadius.all(Radius.circular(1.0)),
                      child: Image(image: NetworkImage(ApiCall.imageUrl + casePhotos[index].imageName),fit: BoxFit.cover,
              ...
              casePhotos[index].selected ? Align(
  ...
  Future <void> reportFalseAlarm() async{
    ...
    CustomResponse response = await ApiCall.makePostRequestToken("incident/falsealarm/add", paramsData: data);
