...
class NewProfile extends StatefulWidget {
  final userId, phoneNumber, country, state, city;
  ...
  static void alertBoxWithOption(BuildContext context){
    showDialog(
        ...
        new CupertinoAlertDialog(
          content: new Text("Do you want to Skip completing Profile? "),
          actions: <Widget>[
        ...
        floatingActionButton:  Opacity(
          ...
          child: MaterialButton(
            ...
            onPressed: () async {
              if(nameOn || genderOn || dobOn || occupationOn ){
                ...
                Navigator.pushReplacement(
                    context, MaterialPageRoute(builder: (context) => AddBasicLocations()));
              }
            ...
            child: Row(
              ...
              children: <Widget>[
                Text(
                  nameOn || genderOn || dobOn || occupationOn ? "Continue": "Skip",
                ...
                child: Container(
                  ...
                  child: Column(
                    children: <Widget>[
                      ...
                      SizedBox(height: 10.0,),
                      Text("Complete your profile", style: TextStyle(color: Colors.teal, fontWeight: FontWeight.w600),),
        ...
        child: Column(
          ...
          children: <Widget>[
            ...
            Container(
              ...
              child: Text("You will have the option to stay anonymous while posting / updating case and commenting on cases.",
                style: TextStyle(fontSize: 12), textAlign: TextAlign.left,),
            ),

            SizedBox(height: 10.0,),
            Divider(
              height: 20.0, thickness: 0.5,
            ),
            Container(
              padding: EdgeInsets.all(8.0),

              width: MediaQuery.of(context).size.width - 20,
              child: Text("We need the following details to learn the demographics about our users.",
            ...
            Padding(
              ...
              child: Text("Gender", style: TextStyle(color: Colors.teal, fontSize: 12),),
            ),
            SizedBox(height: 8.0,),
            Row(
